 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.14.1 (build 828de8a)", date = "2020-11-09T01:37:02.358Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.Secret")
public class Secret extends org.cdk8s.ApiObject {
     ...
     */
    public Secret(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String name, final @org.jetbrains.annotations.Nullable imports.k8s.SecretOptions options) {
    ...
    /**
     * A fluent builder for {@link imports.k8s.Secret}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.k8s.Secret> {
        /**
        ...
        private imports.k8s.SecretOptions.Builder options;
        ...
        /**
         * @returns a newly built instance of {@link imports.k8s.Secret}.
         */
        @Override
        public imports.k8s.Secret build() {
            return new imports.k8s.Secret(
                this.scope,
                this.name,
        ...
        private imports.k8s.SecretOptions.Builder options() {
            if (this.options == null) {
                this.options = new imports.k8s.SecretOptions.Builder();
            }
            return this.options;
        }
    }
