...
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.IngressListOptions")
...
public interface IngressListOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull java.util.List<imports.k8s.Ingress> getItems();
     ...
     */
    public static final class Builder implements software.amazon.jsii.Builder<IngressListOptions> {
        private java.util.List<imports.k8s.Ingress> items;
        ...
        public Builder items(java.util.List<? extends imports.k8s.Ingress> items) {
            this.items = (java.util.List<imports.k8s.Ingress>)items;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements IngressListOptions {
        private final java.util.List<imports.k8s.Ingress> items;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.items = software.amazon.jsii.Kernel.get(this, "items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.Ingress.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.k8s.Ingress> items, final imports.k8s.ListMeta metadata) {
            super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
            this.items = (java.util.List<imports.k8s.Ingress>)java.util.Objects.requireNonNull(items, "items is required");
            this.metadata = metadata;
        }

        @Override
        public final java.util.List<imports.k8s.Ingress> getItems() {
            return this.items;
        }
