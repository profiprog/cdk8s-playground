...
public interface ServiceAccountListOptions extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ServiceAccountListOptions {
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.items = software.amazon.jsii.Kernel.get(this, "items", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.ServiceAccount.class)));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final java.util.List<? extends imports.k8s.ServiceAccount> items, final imports.k8s.ListMeta metadata) {
        ...
        @Override
        public final java.util.List<imports.k8s.ServiceAccount> getItems() {
            return this.items;
        }
