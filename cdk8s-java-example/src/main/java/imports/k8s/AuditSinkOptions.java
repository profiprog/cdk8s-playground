...
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.AuditSinkOptions")
...
public interface AuditSinkOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.AuditSinkSpec getSpec() {
        return null;
    }
     ...
     */
    public static final class Builder implements software.amazon.jsii.Builder<AuditSinkOptions> {
        private imports.k8s.ObjectMeta metadata;
        private imports.k8s.AuditSinkSpec spec;
         ...
         * @return {@code this}
         */
        public Builder spec(imports.k8s.AuditSinkSpec spec) {
            this.spec = spec;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements AuditSinkOptions {
        ...
        private final imports.k8s.AuditSinkSpec spec;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.spec = software.amazon.jsii.Kernel.get(this, "spec", software.amazon.jsii.NativeType.forClass(imports.k8s.AuditSinkSpec.class));
        }

        /**
         * Constructor that initializes the object based on literal property values passed by the {@link Builder}.
         */
        protected Jsii$Proxy(final imports.k8s.ObjectMeta metadata, final imports.k8s.AuditSinkSpec spec) {
        ...
        @Override
        public final imports.k8s.AuditSinkSpec getSpec() {
            return this.spec;
        }
