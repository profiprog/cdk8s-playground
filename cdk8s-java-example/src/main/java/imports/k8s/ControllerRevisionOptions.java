...
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.ControllerRevisionOptions")
...
public interface ControllerRevisionOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.RawExtension getData() {
        return null;
    }
     ...
     */
    public static final class Builder implements software.amazon.jsii.Builder<ControllerRevisionOptions> {
        private java.lang.Number revision;
        private imports.k8s.RawExtension data;
         ...
         * @return {@code this}
         */
        public Builder data(imports.k8s.RawExtension data) {
            this.data = data;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ControllerRevisionOptions {
        ...
        private final imports.k8s.RawExtension data;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.data = software.amazon.jsii.Kernel.get(this, "data", software.amazon.jsii.NativeType.forClass(imports.k8s.RawExtension.class));
         ...
         */
        protected Jsii$Proxy(final java.lang.Number revision, final imports.k8s.RawExtension data, final imports.k8s.ObjectMeta metadata) {
        ...
        @Override
        public final imports.k8s.RawExtension getData() {
            return this.data;
        }
