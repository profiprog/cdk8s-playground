 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.14.1 (build 828de8a)", date = "2020-11-09T01:37:02.336Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.PriorityClass")
public class PriorityClass extends org.cdk8s.ApiObject {
     ...
     */
    public PriorityClass(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String name, final @org.jetbrains.annotations.NotNull imports.k8s.PriorityClassOptions options) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(name, "name is required"), java.util.Objects.requireNonNull(options, "options is required") });
    }

    /**
     * A fluent builder for {@link imports.k8s.PriorityClass}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.k8s.PriorityClass> {
        /**
        ...
        private final imports.k8s.PriorityClassOptions.Builder options;

        private Builder(final software.constructs.Construct scope, final java.lang.String name) {
            this.scope = scope;
            this.name = name;
            this.options = new imports.k8s.PriorityClassOptions.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.k8s.PriorityClass}.
         */
        @Override
        public imports.k8s.PriorityClass build() {
            return new imports.k8s.PriorityClass(
                this.scope,
                this.name,
                this.options.build()
            );
