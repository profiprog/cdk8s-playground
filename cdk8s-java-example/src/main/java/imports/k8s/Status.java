 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.14.1 (build 828de8a)", date = "2020-11-09T01:37:02.382Z")
...
public class Status extends org.cdk8s.ApiObject {
     ...
     */
    public Status(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String name, final @org.jetbrains.annotations.Nullable imports.k8s.StatusOptions options) {
    ...
    /**
     * A fluent builder for {@link imports.k8s.Status}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.k8s.Status> {
        /**
        ...
        private imports.k8s.StatusOptions.Builder options;
        ...
        /**
         * @returns a newly built instance of {@link imports.k8s.Status}.
         */
        @Override
        public imports.k8s.Status build() {
            return new imports.k8s.Status(
                this.scope,
                this.name,
        ...
        private imports.k8s.StatusOptions.Builder options() {
            if (this.options == null) {
                this.options = new imports.k8s.StatusOptions.Builder();
            }
            return this.options;
        }
    }
