 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.14.1 (build 828de8a)", date = "2020-11-09T01:37:02.381Z")
...
public interface StatefulSetSpec extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.PersistentVolumeClaim> getVolumeClaimTemplates() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<StatefulSetSpec> {
        ...
        private java.util.List<imports.k8s.PersistentVolumeClaim> volumeClaimTemplates;
        ...
        public Builder volumeClaimTemplates(java.util.List<? extends imports.k8s.PersistentVolumeClaim> volumeClaimTemplates) {
            this.volumeClaimTemplates = (java.util.List<imports.k8s.PersistentVolumeClaim>)volumeClaimTemplates;
            return this;
        }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements StatefulSetSpec {
        ...
        private final java.util.List<imports.k8s.PersistentVolumeClaim> volumeClaimTemplates;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.volumeClaimTemplates = software.amazon.jsii.Kernel.get(this, "volumeClaimTemplates", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.PersistentVolumeClaim.class)));
        }
        ...
        @Override
        public final java.util.List<imports.k8s.PersistentVolumeClaim> getVolumeClaimTemplates() {
