 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.14.1 (build 828de8a)", date = "2020-11-09T01:37:02.390Z")
...
public interface ValidatingWebhook extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ValidatingWebhook> {
        ...
        public ValidatingWebhook build() {
            return new Jsii$Proxy(clientConfig, name, admissionReviewVersions, failurePolicy, matchPolicy, namespaceSelector, objectSelector, rules, sideEffects, timeoutSeconds);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ValidatingWebhook {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final imports.k8s.WebhookClientConfig clientConfig, final java.lang.String name, final java.util.List<java.lang.String> admissionReviewVersions, final java.lang.String failurePolicy, final java.lang.String matchPolicy, final imports.k8s.LabelSelector namespaceSelector, final imports.k8s.LabelSelector objectSelector, final java.util.List<? extends imports.k8s.RuleWithOperations> rules, final java.lang.String sideEffects, final java.lang.Number timeoutSeconds) {
