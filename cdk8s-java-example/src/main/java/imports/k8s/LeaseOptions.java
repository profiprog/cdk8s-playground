...
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.LeaseOptions")
...
public interface LeaseOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    public static final class Builder implements software.amazon.jsii.Builder<LeaseOptions> {
