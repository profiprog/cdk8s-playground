 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.14.1 (build 828de8a)", date = "2020-11-09T01:37:02.262Z")
...
public interface MutatingWebhook extends software.amazon.jsii.JsiiSerializable {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements MutatingWebhook {
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final imports.k8s.WebhookClientConfig clientConfig, final java.lang.String name, final java.util.List<java.lang.String> admissionReviewVersions, final java.lang.String failurePolicy, final java.lang.String matchPolicy, final imports.k8s.LabelSelector namespaceSelector, final imports.k8s.LabelSelector objectSelector, final java.lang.String reinvocationPolicy, final java.util.List<? extends imports.k8s.RuleWithOperations> rules, final java.lang.String sideEffects, final java.lang.Number timeoutSeconds) {
