...
public interface SecretOptions extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    public static final class Builder implements software.amazon.jsii.Builder<SecretOptions> {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements SecretOptions {
         ...
         */
        protected Jsii$Proxy(final java.util.Map<java.lang.String, java.lang.String> data, final imports.k8s.ObjectMeta metadata, final java.util.Map<java.lang.String, java.lang.String> stringData, final java.lang.String type) {
