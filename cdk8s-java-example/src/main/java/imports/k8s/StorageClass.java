...
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.StorageClass")
public class StorageClass extends org.cdk8s.ApiObject {
     ...
     */
    public StorageClass(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String name, final @org.jetbrains.annotations.NotNull imports.k8s.StorageClassOptions options) {
        super(software.amazon.jsii.JsiiObject.InitializationMode.JSII);
        software.amazon.jsii.JsiiEngine.getInstance().createNewObject(this, new Object[] { java.util.Objects.requireNonNull(scope, "scope is required"), java.util.Objects.requireNonNull(name, "name is required"), java.util.Objects.requireNonNull(options, "options is required") });
    }

    /**
     * A fluent builder for {@link imports.k8s.StorageClass}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.k8s.StorageClass> {
        /**
        ...
        private final imports.k8s.StorageClassOptions.Builder options;

        private Builder(final software.constructs.Construct scope, final java.lang.String name) {
            this.scope = scope;
            this.name = name;
            this.options = new imports.k8s.StorageClassOptions.Builder();
        }
        ...
        /**
         * @returns a newly built instance of {@link imports.k8s.StorageClass}.
         */
        @Override
        public imports.k8s.StorageClass build() {
            return new imports.k8s.StorageClass(
                this.scope,
                this.name,
                this.options.build()
            );
