 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.14.1 (build 828de8a)", date = "2020-11-09T01:37:02.136Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.ConfigMap")
public class ConfigMap extends org.cdk8s.ApiObject {
     ...
     */
    public ConfigMap(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String name, final @org.jetbrains.annotations.Nullable imports.k8s.ConfigMapOptions options) {
    ...
    /**
     * A fluent builder for {@link imports.k8s.ConfigMap}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.k8s.ConfigMap> {
        /**
        ...
        private imports.k8s.ConfigMapOptions.Builder options;
        ...
        /**
         * @returns a newly built instance of {@link imports.k8s.ConfigMap}.
         */
        @Override
        public imports.k8s.ConfigMap build() {
            return new imports.k8s.ConfigMap(
                this.scope,
                this.name,
        ...
        private imports.k8s.ConfigMapOptions.Builder options() {
            if (this.options == null) {
                this.options = new imports.k8s.ConfigMapOptions.Builder();
            }
            return this.options;
        }
    }
