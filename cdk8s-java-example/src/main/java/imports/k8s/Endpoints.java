 ...
 * ]
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.14.1 (build 828de8a)", date = "2020-11-09T01:37:02.193Z")
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.Endpoints")
public class Endpoints extends org.cdk8s.ApiObject {
     ...
     */
    public Endpoints(final @org.jetbrains.annotations.NotNull software.constructs.Construct scope, final @org.jetbrains.annotations.NotNull java.lang.String name, final @org.jetbrains.annotations.Nullable imports.k8s.EndpointsOptions options) {
    ...
    /**
     * A fluent builder for {@link imports.k8s.Endpoints}.
     */
    public static final class Builder implements software.amazon.jsii.Builder<imports.k8s.Endpoints> {
        /**
        ...
        private imports.k8s.EndpointsOptions.Builder options;
        ...
        /**
         * @returns a newly built instance of {@link imports.k8s.Endpoints}.
         */
        @Override
        public imports.k8s.Endpoints build() {
            return new imports.k8s.Endpoints(
                this.scope,
                this.name,
        ...
        private imports.k8s.EndpointsOptions.Builder options() {
            if (this.options == null) {
                this.options = new imports.k8s.EndpointsOptions.Builder();
            }
            return this.options;
        }
    }
