 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.14.1 (build 828de8a)", date = "2020-11-09T01:37:02.168Z")
...
public interface CustomResourceColumnDefinition extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable java.lang.String getJsonPath() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<CustomResourceColumnDefinition> {
         ...
         * @param jsonPath JSONPath is a simple JSON path, i.e. with array notation.
         * @return {@code this}
         */
        ...
        public CustomResourceColumnDefinition build() {
            return new Jsii$Proxy(name, type, description, format, jsonPath, priority);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements CustomResourceColumnDefinition {
         ...
         */
        protected Jsii$Proxy(final java.lang.String name, final java.lang.String type, final java.lang.String description, final java.lang.String format, final java.lang.String jsonPath, final java.lang.Number priority) {
