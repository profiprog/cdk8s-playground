 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.14.1 (build 828de8a)", date = "2020-11-09T01:37:02.377Z")
...
public interface ServiceSpec extends software.amazon.jsii.JsiiSerializable {
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ServiceSpec> {
        ...
        public ServiceSpec build() {
            return new Jsii$Proxy(clusterIp, externalIPs, externalName, externalTrafficPolicy, healthCheckNodePort, loadBalancerIp, loadBalancerSourceRanges, ports, publishNotReadyAddresses, selector, sessionAffinity, sessionAffinityConfig, type);
        }
    }
