...
@software.amazon.jsii.Jsii(module = imports.k8s.$Module.class, fqn = "k8s.PodSecurityPolicySpec")
...
public interface PodSecurityPolicySpec extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    @org.jetbrains.annotations.NotNull imports.k8s.FsGroupStrategyOptions getFsGroup();

    /**
     * runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.
     */
    @org.jetbrains.annotations.NotNull imports.k8s.RunAsUserStrategyOptions getRunAsUser();

    /**
     * seLinux is the strategy that will dictate the allowable labels that may be set.
     */
    @org.jetbrains.annotations.NotNull imports.k8s.SeLinuxStrategyOptions getSeLinux();

    /**
     * supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
     */
    @org.jetbrains.annotations.NotNull imports.k8s.SupplementalGroupsStrategyOptions getSupplementalGroups();
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.AllowedCsiDriver> getAllowedCsiDrivers() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.AllowedFlexVolume> getAllowedFlexVolumes() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.AllowedHostPath> getAllowedHostPaths() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable java.util.List<imports.k8s.HostPortRange> getHostPorts() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.RunAsGroupStrategyOptions getRunAsGroup() {
        return null;
    }
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.RuntimeClassStrategyOptions getRuntimeClass() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<PodSecurityPolicySpec> {
        private imports.k8s.FsGroupStrategyOptions fsGroup;
        private imports.k8s.RunAsUserStrategyOptions runAsUser;
        private imports.k8s.SeLinuxStrategyOptions seLinux;
        private imports.k8s.SupplementalGroupsStrategyOptions supplementalGroups;
        private java.util.List<java.lang.String> allowedCapabilities;
        private java.util.List<imports.k8s.AllowedCsiDriver> allowedCsiDrivers;
        private java.util.List<imports.k8s.AllowedFlexVolume> allowedFlexVolumes;
        private java.util.List<imports.k8s.AllowedHostPath> allowedHostPaths;
        ...
        private java.util.List<imports.k8s.HostPortRange> hostPorts;
        ...
        private imports.k8s.RunAsGroupStrategyOptions runAsGroup;
        private imports.k8s.RuntimeClassStrategyOptions runtimeClass;
         ...
         * @return {@code this}
         */
        public Builder fsGroup(imports.k8s.FsGroupStrategyOptions fsGroup) {
         ...
         * @return {@code this}
         */
        public Builder runAsUser(imports.k8s.RunAsUserStrategyOptions runAsUser) {
         ...
         * @return {@code this}
         */
        public Builder seLinux(imports.k8s.SeLinuxStrategyOptions seLinux) {
         ...
         * @return {@code this}
         */
        public Builder supplementalGroups(imports.k8s.SupplementalGroupsStrategyOptions supplementalGroups) {
        ...
        public Builder allowedCsiDrivers(java.util.List<? extends imports.k8s.AllowedCsiDriver> allowedCsiDrivers) {
            this.allowedCsiDrivers = (java.util.List<imports.k8s.AllowedCsiDriver>)allowedCsiDrivers;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder allowedFlexVolumes(java.util.List<? extends imports.k8s.AllowedFlexVolume> allowedFlexVolumes) {
            this.allowedFlexVolumes = (java.util.List<imports.k8s.AllowedFlexVolume>)allowedFlexVolumes;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder allowedHostPaths(java.util.List<? extends imports.k8s.AllowedHostPath> allowedHostPaths) {
            this.allowedHostPaths = (java.util.List<imports.k8s.AllowedHostPath>)allowedHostPaths;
            return this;
        }
         ...
         */
        @SuppressWarnings("unchecked")
        public Builder hostPorts(java.util.List<? extends imports.k8s.HostPortRange> hostPorts) {
            this.hostPorts = (java.util.List<imports.k8s.HostPortRange>)hostPorts;
            return this;
        }
         ...
         * @return {@code this}
         */
        public Builder runAsGroup(imports.k8s.RunAsGroupStrategyOptions runAsGroup) {
         ...
         * @return {@code this}
         */
        public Builder runtimeClass(imports.k8s.RuntimeClassStrategyOptions runtimeClass) {
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements PodSecurityPolicySpec {
        private final imports.k8s.FsGroupStrategyOptions fsGroup;
        private final imports.k8s.RunAsUserStrategyOptions runAsUser;
        private final imports.k8s.SeLinuxStrategyOptions seLinux;
        private final imports.k8s.SupplementalGroupsStrategyOptions supplementalGroups;
        private final java.util.List<java.lang.String> allowedCapabilities;
        private final java.util.List<imports.k8s.AllowedCsiDriver> allowedCsiDrivers;
        private final java.util.List<imports.k8s.AllowedFlexVolume> allowedFlexVolumes;
        private final java.util.List<imports.k8s.AllowedHostPath> allowedHostPaths;
        ...
        private final java.util.List<imports.k8s.HostPortRange> hostPorts;
        ...
        private final imports.k8s.RunAsGroupStrategyOptions runAsGroup;
        private final imports.k8s.RuntimeClassStrategyOptions runtimeClass;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            super(objRef);
            this.fsGroup = software.amazon.jsii.Kernel.get(this, "fsGroup", software.amazon.jsii.NativeType.forClass(imports.k8s.FsGroupStrategyOptions.class));
            this.runAsUser = software.amazon.jsii.Kernel.get(this, "runAsUser", software.amazon.jsii.NativeType.forClass(imports.k8s.RunAsUserStrategyOptions.class));
            this.seLinux = software.amazon.jsii.Kernel.get(this, "seLinux", software.amazon.jsii.NativeType.forClass(imports.k8s.SeLinuxStrategyOptions.class));
            this.supplementalGroups = software.amazon.jsii.Kernel.get(this, "supplementalGroups", software.amazon.jsii.NativeType.forClass(imports.k8s.SupplementalGroupsStrategyOptions.class));
            ...
            this.allowedCsiDrivers = software.amazon.jsii.Kernel.get(this, "allowedCSIDrivers", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.AllowedCsiDriver.class)));
            this.allowedFlexVolumes = software.amazon.jsii.Kernel.get(this, "allowedFlexVolumes", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.AllowedFlexVolume.class)));
            this.allowedHostPaths = software.amazon.jsii.Kernel.get(this, "allowedHostPaths", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.AllowedHostPath.class)));
            ...
            this.hostPorts = software.amazon.jsii.Kernel.get(this, "hostPorts", software.amazon.jsii.NativeType.listOf(software.amazon.jsii.NativeType.forClass(imports.k8s.HostPortRange.class)));
            ...
            this.runAsGroup = software.amazon.jsii.Kernel.get(this, "runAsGroup", software.amazon.jsii.NativeType.forClass(imports.k8s.RunAsGroupStrategyOptions.class));
            this.runtimeClass = software.amazon.jsii.Kernel.get(this, "runtimeClass", software.amazon.jsii.NativeType.forClass(imports.k8s.RuntimeClassStrategyOptions.class));
         ...
         */
        @SuppressWarnings("unchecked")
        protected Jsii$Proxy(final imports.k8s.FsGroupStrategyOptions fsGroup, final imports.k8s.RunAsUserStrategyOptions runAsUser, final imports.k8s.SeLinuxStrategyOptions seLinux, final imports.k8s.SupplementalGroupsStrategyOptions supplementalGroups, final java.util.List<java.lang.String> allowedCapabilities, final java.util.List<? extends imports.k8s.AllowedCsiDriver> allowedCsiDrivers, final java.util.List<? extends imports.k8s.AllowedFlexVolume> allowedFlexVolumes, final java.util.List<? extends imports.k8s.AllowedHostPath> allowedHostPaths, final java.util.List<java.lang.String> allowedProcMountTypes, final java.util.List<java.lang.String> allowedUnsafeSysctls, final java.lang.Boolean allowPrivilegeEscalation, final java.util.List<java.lang.String> defaultAddCapabilities, final java.lang.Boolean defaultAllowPrivilegeEscalation, final java.util.List<java.lang.String> forbiddenSysctls, final java.lang.Boolean hostIpc, final java.lang.Boolean hostNetwork, final java.lang.Boolean hostPid, final java.util.List<? extends imports.k8s.HostPortRange> hostPorts, final java.lang.Boolean privileged, final java.lang.Boolean readOnlyRootFilesystem, final java.util.List<java.lang.String> requiredDropCapabilities, final imports.k8s.RunAsGroupStrategyOptions runAsGroup, final imports.k8s.RuntimeClassStrategyOptions runtimeClass, final java.util.List<java.lang.String> volumes) {
        ...
        @Override
        public final imports.k8s.FsGroupStrategyOptions getFsGroup() {
            return this.fsGroup;
        }

        @Override
        public final imports.k8s.RunAsUserStrategyOptions getRunAsUser() {
            return this.runAsUser;
        }

        @Override
        public final imports.k8s.SeLinuxStrategyOptions getSeLinux() {
            return this.seLinux;
        }

        @Override
        public final imports.k8s.SupplementalGroupsStrategyOptions getSupplementalGroups() {
        ...
        @Override
        public final java.util.List<imports.k8s.AllowedCsiDriver> getAllowedCsiDrivers() {
            return this.allowedCsiDrivers;
        }

        @Override
        public final java.util.List<imports.k8s.AllowedFlexVolume> getAllowedFlexVolumes() {
            return this.allowedFlexVolumes;
        }

        @Override
        public final java.util.List<imports.k8s.AllowedHostPath> getAllowedHostPaths() {
        ...
        @Override
        public final java.util.List<imports.k8s.HostPortRange> getHostPorts() {
        ...
        @Override
        public final imports.k8s.RunAsGroupStrategyOptions getRunAsGroup() {
            return this.runAsGroup;
        }

        @Override
        public final imports.k8s.RuntimeClassStrategyOptions getRuntimeClass() {
