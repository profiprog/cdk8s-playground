 ...
 */
@javax.annotation.Generated(value = "jsii-pacmak/1.14.1 (build 828de8a)", date = "2020-11-09T01:37:02.296Z")
...
public interface ObjectMeta extends software.amazon.jsii.JsiiSerializable {
     ...
     */
    default @org.jetbrains.annotations.Nullable imports.k8s.Initializers getInitializers() {
        return null;
    }
    ...
    public static final class Builder implements software.amazon.jsii.Builder<ObjectMeta> {
        ...
        private imports.k8s.Initializers initializers;
        ...
        /**
         * Sets the value of {@link ObjectMeta#getInitializers}
         * @param initializers An initializer is a controller which enforces some system invariant at object creation time.
         *                     This field is a list of initializers that have not yet acted on this object. If nil or empty, this object has been completely initialized. Otherwise, the object is considered uninitialized and is hidden (in list/watch and get calls) from clients that haven't explicitly asked to observe uninitialized objects.
         *                     <p>
         *                     When an object is created, the system will populate this list with the current set of initializers. Only privileged users may set or modify this list. Once it is empty, it may not be modified further by any user.
         *                     <p>
         ...
         * @return {@code this}
         */
        public Builder initializers(imports.k8s.Initializers initializers) {
        ...
        public ObjectMeta build() {
            return new Jsii$Proxy(annotations, clusterName, creationTimestamp, deletionGracePeriodSeconds, deletionTimestamp, finalizers, generateName, generation, initializers, labels, managedFields, name, namespace, ownerReferences, resourceVersion, selfLink, uid);
        }
    }
    ...
    final class Jsii$Proxy extends software.amazon.jsii.JsiiObject implements ObjectMeta {
        ...
        private final imports.k8s.Initializers initializers;
        ...
        protected Jsii$Proxy(final software.amazon.jsii.JsiiObjectRef objRef) {
            ...
            this.initializers = software.amazon.jsii.Kernel.get(this, "initializers", software.amazon.jsii.NativeType.forClass(imports.k8s.Initializers.class));
        ...
        @Override
        public final imports.k8s.Initializers getInitializers() {
        ...
        public com.fasterxml.jackson.databind.JsonNode $jsii$toJson() {
            ...
            if (this.getInitializers() != null) {
                data.set("initializers", om.valueToTree(this.getInitializers()));
            }
        ...
        public final boolean equals(final Object o) {
            ...
            if (this.initializers != null ? !this.initializers.equals(that.initializers) : that.initializers != null) return false;
        ...
        public final int hashCode() {
            ...
            result = 31 * result + (this.initializers != null ? this.initializers.hashCode() : 0);
